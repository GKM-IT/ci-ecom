...
class Stocks extends REST_Controller
{
    ...
    private function getData($object)
    {
        ...
        if ($object) :
            $result = [
                ...
                'productImageThumb' => base_url($object['productImage']),
                'location' => $object['location'],
                'price' => $this->settings_lib->number_format($object['price']),
                'quantity' => $this->settings_lib->number_format($object['quantity']),
                'text' => $object['text'],
                'type' => $object['type'],
                'type_text' => $object['type'] == 'i' ? $this->lang->line('text_in') : $this->lang->line('text_out'),
    ...
    public function index_post()
    {
        ...
        $list = $this->stocks_model->getTables();
        ...
        $this->data['recordsTotal'] = $this->stocks_model->countAll();
        $this->data['recordsFiltered'] = $this->stocks_model->countFiltered();
    ...
    public function delete_get($id)
    {
        ...
        $object = $this->stocks_model->deleteById($id);
    ...
    public function detail_post()
    {
        ...
        $object = $this->stocks_model->getById($id);
