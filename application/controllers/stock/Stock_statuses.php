...
class Stock_statuses extends REST_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('stock/stock_statuses_model');
    ...
    public function index_post()
    {
        ...
        $list = $this->stock_statuses_model->getTables();
        ...
        $this->data['recordsTotal'] = $this->stock_statuses_model->countAll();
        $this->data['recordsFiltered'] = $this->stock_statuses_model->countFiltered();
    ...
    public function delete_get($id)
    {
        ...
        $object = $this->stock_statuses_model->deleteById($id);
    ...
    public function detail_post()
    {
        ...
        $object = $this->stock_statuses_model->getById($id);
    ...
    public function save_post()
    {
        ...
        $object = $this->stock_statuses_model->save();
