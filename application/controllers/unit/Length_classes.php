...
class Length_classes extends REST_Controller {
    ...
    public function __construct() {
        parent::__construct();
        $this->load->model('unit/length_classes_model');
    ...
    public function index_post() {
        ...
        $list = $this->length_classes_model->getTables();
        ...
        $this->data['recordsTotal'] = $this->length_classes_model->countAll();
        $this->data['recordsFiltered'] = $this->length_classes_model->countFiltered();
    ...
    public function delete_get($id) {
        ...
        $object = $this->length_classes_model->deleteById($id);
    ...
    public function detail_post() {
        ...
        $object = $this->length_classes_model->getById($id);
    ...
    public function save_post() {
        ...
        $object = $this->length_classes_model->save();
