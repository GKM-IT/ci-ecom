...
class Tax_rates extends REST_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('tax/tax_rates_model');
    ...
    public function index_post()
    {
        ...
        $this->data['recordsTotal'] = $this->tax_rates_model->countAll();
        $this->data['recordsFiltered'] = $this->tax_rates_model->countFiltered();
