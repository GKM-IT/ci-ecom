...
class Vendors extends REST_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('vendor/vendors_model');
    ...
    public function index_post()
    {
        ...
        $list = $this->vendors_model->getTables();
        ...
        $this->data['recordsTotal'] = $this->vendors_model->countAll();
        $this->data['recordsFiltered'] = $this->vendors_model->countFiltered();
    ...
    public function delete_get($id)
    {
        ...
        $object = $this->vendors_model->deleteById($id);

        $result = [];
        if ($object):
            $this->data['status'] = true;
            $this->data['message'] = sprintf($this->lang->line('success_delete'), $this->lang->line('text_vendor'));
            $result = $object;
        else:
            $this->data['status'] = false;
            $this->data['error'] = sprintf($this->lang->line('error_delete'), $this->lang->line('text_vendor'));
        endif;
    ...
    public function detail_post()
    {
        ...
        $object = $this->vendors_model->getById($id);
        ...
        if ($object):
            ...
            $this->data['status'] = false;
            $this->data['error'] = sprintf($this->lang->line('error_not_found'), $this->lang->line('text_vendor'));
        endif;
    ...
    public function save_post()
    {
        ...
        $object = $this->vendors_model->save();

        $result = [];
        if ($object):
            $this->data['status'] = true;
            $this->data['message'] = sprintf($this->lang->line('success_save'), $this->lang->line('text_vendor'));
            $result = $object;
        else:
            $this->data['status'] = false;
            $this->data['error'] = sprintf($this->lang->line('error_save'), $this->lang->line('text_vendor'));
        endif;
    ...
    {
        if ($this->vendors_model->getByEmail($field_value)):
    ...
    {
        if ($this->vendors_model->getByContact($field_value)):
