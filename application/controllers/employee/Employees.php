...
class Employees extends REST_Controller {
    ...
    public function index_post() {
        ...
        $list = $this->employees_model->getTables();
        ...
        $this->data['recordsTotal'] = $this->employees_model->countAll();
        $this->data['recordsFiltered'] = $this->employees_model->countFiltered();
    ...
    public function delete_get($id) {
        ...
        $object = $this->employees_model->deleteById($id);

        $result = [];
        if ($object):
            $this->data['status'] = true;
            $this->data['message'] = sprintf($this->lang->line('success_delete'), $this->lang->line('text_employee'));
            $result = $object;
        else:
            $this->data['status'] = false;
            $this->data['error'] = sprintf($this->lang->line('error_delete'), $this->lang->line('text_employee'));
        endif;
    ...
    public function detail_post() {
        ...
        $object = $this->employees_model->getById($id);
        ...
        if ($object):
            ...
            $this->data['status'] = false;
            $this->data['error'] = sprintf($this->lang->line('error_not_found'), $this->lang->line('text_employee'));
        endif;
    ...
    public function save_post() {
        ...
        $object = $this->employees_model->save();

        $result = [];
        if ($object):
            $this->data['status'] = true;
            $this->data['message'] = sprintf($this->lang->line('success_save'), $this->lang->line('text_employee'));
            $result = $object;
        else:
            $this->data['status'] = false;
            $this->data['error'] = sprintf($this->lang->line('error_save'), $this->lang->line('text_employee'));
        endif;
    ...
    public function validate_email($field_value) {
        if ($this->employees_model->getByEmail($field_value)) :
    ...
    public function validate_contact($field_value) {
        if ($this->employees_model->getByContact($field_value)) :
