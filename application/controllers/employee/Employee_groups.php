...
class Employee_groups extends REST_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('employee/employee_groups_model');
    ...
    public function index_post()
    {
        ...
        $list = $this->employee_groups_model->getTables();
        ...
        $this->data['recordsTotal'] = $this->employee_groups_model->countAll();
        $this->data['recordsFiltered'] = $this->employee_groups_model->countFiltered();
    ...
    public function delete_get($id)
    {
        ...
        $object = $this->employee_groups_model->deleteById($id);
    ...
    public function detail_post()
    {
        ...
        $this->data['data'] = [];
        $id = $this->post('id');
        $object = $this->employee_groups_model->getById($id);
    ...
    public function save_post()
    {
        ...
        $object = $this->employee_groups_model->save();
