...
class Inquiry_types extends REST_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('information/inquiry_types_model');
    ...
    public function delete_get($id)
    {
        ...
        $object = $this->inquiry_types_model->deleteById($id);
    ...
    public function save_post()
    {
        ...
        $object = $this->inquiry_types_model->save();
