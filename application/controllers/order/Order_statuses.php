...
class Order_statuses extends REST_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('order/order_statuses_model');
    ...
    public function index_post()
    {
        ...
        $list = $this->order_statuses_model->getTables();
        ...
        $this->data['recordsTotal'] = $this->order_statuses_model->countAll();
        $this->data['recordsFiltered'] = $this->order_statuses_model->countFiltered();
    ...
    public function delete_get($id)
    {
        ...
        $object = $this->order_statuses_model->deleteById($id);
    ...
    public function detail_post()
    {
        ...
        $object = $this->order_statuses_model->getById($id);
    ...
    public function save_post()
    {
        ...
        $object = $this->order_statuses_model->save();
