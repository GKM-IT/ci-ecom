...
class Order_types extends REST_Controller {
    ...
    public function __construct() {
        parent::__construct();
        $this->load->model('order/order_types_model');
    ...
    public function index_post() {
        ...
        $list = $this->order_types_model->getTables();
        ...
        $this->data['recordsTotal'] = $this->order_types_model->countAll();
        $this->data['recordsFiltered'] = $this->order_types_model->countFiltered();
    ...
    public function delete_get($id) {
        ...
        $object = $this->order_types_model->deleteById($id);
    ...
    public function detail_post() {
        ...
        $object = $this->order_types_model->getById($id);
    ...
    public function save_post() {
        ...
        $object = $this->order_types_model->save();
