...
class Currencies extends REST_Controller
{
    ...
    public function index_post()
    {
        ...
        $list = $this->currencies_model->getTables();
        ...
        if ($list):
            foreach ($list as $object):
                $result[] = [
                    ...
                    'name' => $object['name'],
                    'code' => $object['code'],
                    'symbol_left' => $object['symbol_left'],
                    'symbol_right' => $object['symbol_right'],
                    'decimal_place' => $object['decimal_place'],
                    'value' => $object['value'],
                    'image' => $object['image'],
    ...
    public function detail_post()
    {
        ...
        $object = $this->currencies_model->getById($id);
    ...
    public function save_post()
    {
        ...
        $object = $this->currencies_model->save();
