...
class Ratings extends REST_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('common/ratings_model');
    ...
    public function index_post()
    {
        ...
        $list = $this->ratings_model->getTables();
        ...
        $this->data['recordsTotal'] = $this->ratings_model->countAll();
        $this->data['recordsFiltered'] = $this->ratings_model->countFiltered();
    ...
    public function delete_get($id)
    {
        ...
        $object = $this->ratings_model->deleteById($id);
    ...
    public function detail_post()
    {
        ...
        $object = $this->ratings_model->getById($id);
    ...
    public function save_post()
    {
        ...
        $object = $this->ratings_model->save();
