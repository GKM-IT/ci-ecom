...
class TotalSalesDay extends REST_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('report/TotalSalesDay_model');
    ...
    public function index_post()
    {
        ...
        $list = $this->TotalSalesDay_model->getTables();
        ...
        $this->data['recordsTotal'] = $this->TotalSalesDay_model->countAll();
        $this->data['recordsFiltered'] = $this->TotalSalesDay_model->countFiltered();
