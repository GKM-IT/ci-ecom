...
class TotalSales extends REST_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('report/TotalSales_model');
    ...
    public function index_post()
    {
        ...
        $list = $this->TotalSales_model->getTables();
        ...
        $this->data['recordsTotal'] = $this->TotalSales_model->countAll();
        $this->data['recordsFiltered'] = $this->TotalSales_model->countFiltered();
