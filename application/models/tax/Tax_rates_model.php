...
class Tax_rates_model extends CI_Model {
    ...
    private $table_view = 'tax_rates';
    private $column_order = array(null, 'name', 'rate', 'type', 'status', 'updated_at', null);
    private $column_search = array('name', 'rate', 'type', 'status', 'updated_at');
