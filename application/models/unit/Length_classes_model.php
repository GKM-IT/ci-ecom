...
class Length_classes_model extends CI_Model {

    private $table = 'length_classes';
    private $table_view = 'length_classes';
    private $column_order = array(null, 'name', 'unit', 'value', 'sort_order', 'status', 'updated_at', null);
    private $column_search = array('name', 'unit', 'value', 'sort_order', 'status', 'updated_at');
