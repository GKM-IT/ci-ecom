...
class Purchase_statuses_model extends CI_Model {

    private $table = 'purchase_statuses';
    private $table_view = 'purchase_statuses';
    private $column_purchase = array(null, 'name', 'status', 'updated_at', null);
